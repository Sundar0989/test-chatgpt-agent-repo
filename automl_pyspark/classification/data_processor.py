...
class DataProcessor:
    ...
    def preprocess(self, data: DataFrame, target_column: str, config: Dict) -> tuple:
        ...
        # Store original categorical variable names before encoding
        original_categorical_vars = categorical_vars.copy()
        ...
        return processed_data, selected_vars, original_categorical_vars, numerical_vars
    ...
    def _restart_spark_session(self):
        ...
        """
        raise NotImplementedError("Spark session restart is now handled by the background job manager.")