...
class AutoMLClusterer:
    ...
    def __init__(self, 
        ...
        self.model_selector = ClusteringModelSelector(self.output_dir, self.actual_user_id, self.actual_model_literal)
            ...
            for model_type, model_data in self.trained_models.items():
                ...
                try:
                    ...
                    if os.path.exists(model_path):
                        ...
                        print(f"   ⚠️ Model directory was not created: {model_path}")
